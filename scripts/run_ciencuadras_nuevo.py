"""
scripts/run_ciencuadras_nuevo.py
=================================
Runner individual para CienCuadras — Proyectos de vivienda NUEVA.

Uso:
    python scripts/run_ciencuadras_nuevo.py              # 10 páginas (default)
    python scripts/run_ciencuadras_nuevo.py --pages 50   # N páginas
    python scripts/run_ciencuadras_nuevo.py --headed      # Ventana visible
    python scripts/run_ciencuadras_nuevo.py --show        # Imprime registros en consola
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Scraper — CienCuadras Nuevo",
