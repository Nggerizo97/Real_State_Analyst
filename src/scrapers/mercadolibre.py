...
class MercadoLibreScraper(BaseScraper):
    ...
    def scrape_pages(self, page: Page, max_pages: int):
        ...
        for current_page in range(1, max_pages + 1):
            ...
            self.human_delay(page) # Simula humano esperando
            
            # Buscar el contenedor principal de cada resultado de ML
            ...
            next_button = page.query_selector("a.andes-pagination__link.ui-search-link[title='Siguiente']")
            if next_button:
